...
export function registerSmoothWheelZoom(L: any) {
  if (!L || !L.Map || L.Map.SmoothWheelZoom) return;
  ...
  L.Map.SmoothWheelZoom = L.Handler.extend({
    ...
    _onWheelScroll: function (this: any, e: any) {
      if (!this._isWheeling) {
    ...
    _onWheelStart: function (this: any, e: any) {
      const map = this._map;
    ...
    _onWheeling: function (this: any, e: any) {
      const map = this._map;
